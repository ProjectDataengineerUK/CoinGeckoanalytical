...
def mini_card(x, y, w, h, title, desc, icon_kind, fill, edge, title_size=6.8,
    ...
    round_box(x + 0.18, y + h - 3.0, 2.85, 2.55, C_WHITE, edge, lw=1.1, radius=0.20, z=4)
    draw_icon(icon_kind, x + 0.36, y + h - 2.82, 2.4, edge)
...
plt.savefig("docs/assets/coingeckoanalytical-architecture-v4.png", dpi=DPI, bbox_inches="tight")
